...
export default class trackLayer extends baseLayer {
    ...
    initTrackData(polyline) {
        ...
        let route = hyFeature.createLine(polyline);
        console.log(route)
