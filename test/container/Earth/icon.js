 ...
 * @Last Modified time: 2017-07-27 16:29:17
...
class icon extends Component {
    componentDidMount() {
        ...
        mapObj.setTooltip({
            ...
            formatter: function(param, dom) { //div内的内容
        ...
        mapObj.on('contextmenu', function(e) {
            ...
            console.log(e);
            e.element.innerHTML = '<a onclick="javascript:alert();" id=1>sss</a><a id=1>sss</a><a id=1>sss</a><a id=1>sss</a><a id=1>sss</a><a id=1>sss</a>'
